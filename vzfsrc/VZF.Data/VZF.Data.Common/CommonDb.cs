...
// File CommonDb.cs created  on 2.6.2015 in  6:29 AM.
// Last changed on 5.20.2016 in 3:15 PM.
    ...
    public static class CommonDb
    {
        ...
        public static DataTable forumaccess_group(int? mid, object groupId, object userId, bool includeUserForums)
        {
            using (var sc = new VzfSqlCommand(mid))
            {
                ...
                return userforumaccess_sort_list(sc.ExecuteDataTableFromReader(CommandBehavior.Default, CommandType.StoredProcedure, true),
                    0,
                    0);
            }
        }

        private static  DataTable userforumaccess_sort_list(DataTable listSource,
            int parentId,
            int startingIndent)
        {
        ...
        ///  The user groups. 
        /// </param>
        /// <param name="commonGroups"> 
        /// The common groups.
        /// </param>
        /// <param name="adminGroups">
        /// The include admin groups.
        /// </param>
        /// <returns>
        /// The <see cref="T:System.Data.DataTable"/>.
        /// </returns>
        ...
        ///     <TypedForumListAll>"/></TypedForumListAll></see>
        /// </returns>
        ...
        public static bool forumpage_initdb(int? mid, out string errorStr, bool debugging)
        {
            ...
            using (var sc = new VzfSqlCommand(mid))
            {
                ...
                errorStr = debugging ? "Unable to connect to the Database. Debug." : "Unable to connect to the Database.";
        ...
        /// </param>       
        public static void nntptopic_addmessage(
            int? mid,
            object nntpForumId,
            object topic,
            object body,
            ...
            object referenceMessageId)
        {
            using (var sc = new VzfSqlCommand(mid))
            {
                ...
                sc.CommandText.AppendObjectQuery("nntptopic_addmessage", mid);
                sc.ExecuteNonQuery(CommandType.StoredProcedure);
            }
        }
        ...
        /// The <see cref="T:System.Data.DataTable"/>.
        /// </returns>
        public static DataTable registry_list(int? mid, string name)
        {
        ...
        /// The <see cref="T:System.Data.DataTable"/>.
        /// </returns>    
        public static DataTable registry_list(int? mid, string name, object boardId)
        {
            using (var sc = new VzfSqlCommand(mid))
            {
                sc.Parameters.Add(
        ...
        /// <exception cref="ArgumentOutOfRangeException">
        /// </exception>
        public static List<string> GetScriptList(int? mid)
        {
            string dataEngine;
            string connectionString;
            ...
            {
                case SqlDbAccess.MsSql:
                    scriptFolder = VZF.Data.MsSql.Db.ScriptFolder;                    
                    break;
                case SqlDbAccess.Npgsql:
                    scriptFolder = VZF.Data.Postgre.Db.ScriptFolder;
                    break;
                case SqlDbAccess.MySql:
                    scriptFolder = VZF.Data.Mysql.Db.ScriptFolder;                
                    break;
                case SqlDbAccess.Firebird:
                    scriptFolder = VZF.Data.Firebird.Db.ScriptFolder;
                    break;
                default:
                    throw new ArgumentOutOfRangeException(dataEngine);
            }

            string[] coreSriptList =
            {
                "preinstall",
                "providers/procedures_drop",
                "procedures_drop",
                "functions_drop",
                "views_drop",
                "exceptions_drop",
            ...
            return coreSriptList.Select(script => "{0}/{1}.sql".FormatWith(scriptFolder, script)).ToList();
        }
        ...
        public static bool DbInstallTransactions(int? mid)
        {
            string dataEngine;
            string connectionString;
            string namePattern = string.Empty;
            ...
            {
                case SqlDbAccess.MsSql:
                    return VZF.Data.MsSql.Db.DbInstallTransactions;
                case SqlDbAccess.Npgsql:
                    return VZF.Data.Postgre.Db.DbInstallTransactions;
                case SqlDbAccess.MySql:
                    return VZF.Data.Mysql.Db.DbInstallTransactions;
                case SqlDbAccess.Firebird:
                    return VZF.Data.Firebird.Db.DbInstallTransactions;
                default:
                    throw new ArgumentOutOfRangeException(dataEngine);
            }
        }
