...
namespace VZF.Data.Firebird
{
    ...
    public static class Db
    {
        ...
        /// </summary>
        private static List<ConnectionParams> connectionParams;
                    ...
                    new ConnectionParams
                        {
                            Name = "Database",
                            Type = typeof(string),
                            Value = HttpContext.Current.Server.MapPath("~/App_Data/yafnet.fdb")
                        });
                connectionParams.Add(new ConnectionParams { Name = "Dialect", Type = typeof(string), Value = 3 });
                connectionParams.Add(new ConnectionParams { Name = "Charset", Type = typeof(string), Value = "UTF8" });
                connectionParams.Add(new ConnectionParams { Name = "Port", Type = typeof(string), Value = 3050 });
                connectionParams.Add(new ConnectionParams { Name = "Server Type", Type = typeof(string), Value = 0 });
                connectionParams.Add(new ConnectionParams { Name = "Packet Size", Type = typeof(string), Value = 8192 });
                connectionParams.Add(
        ...
        /// <summary>
        /// Gets a value indicating whether parameter 3_ visible.
        /// </summary>
            ...
            object donttrack)
        {
            ...
            if (strdonttrack == "false")
            {
                donttrack = 0;
            }
            if (strdonttrack == "true")
            {
                donttrack = 1;
            }
            if (isMobileDevice.ToString() == "false")
            {
                isMobileDevice = 0;
            }
            if (isCrawler.ToString() == "true")
            {
                isCrawler = 1;
            }
            if (isCrawler.ToString() == "false")
            {
                isCrawler = 0;
            }
            if (isMobileDevice.ToString() == "true")
            {
                isMobileDevice = 1;
            }
            int nTries = 0;
            while (true)
            {
                try
                {
                    using (FbCommand cmd = FbDbAccess.GetCommand("PAGELOAD"))
                    {
                        ...
                        else cmd.Parameters.Add(new FbParameter("@I_USERKEY", FbDbType.VarChar)).Value = DBNull.Value;
                        ...
                        cmd.Parameters.Add(new FbParameter("@I_ISMOBILEDEVICE", FbDbType.Boolean)).Value =
                            isMobileDevice;
                        cmd.Parameters.Add(new FbParameter("@I_DONTTRACK", FbDbType.Boolean)).Value = donttrack;
                        cmd.Parameters.Add(new FbParameter("@I_UTCTIMESTAMP", FbDbType.TimeStamp)).Value =
                            DateTime.UtcNow;
        ...
        private static void forum_list_sort_basic(
            string connectionString, DataTable listsource, DataTable list, int parentid, int currentLvl)
        {
        ...
        public static DataTable post_last10user(
            string connectionString, object boardID, object userID, object pageUserID)
        {
        ...
        public static int? poll_save(
            string connectionString, [NotNull] System.Collections.Generic.List<PollSaveList> pollList)
        {
        ...
        public static int TopicFavoriteCount(string connectionString, int topicId)
        {
            using (FbCommand cmd = FbDbAccess.GetCommand("topic_favorite_count"))
            {
                ...
                return FbDbAccess.GetData(cmd, connectionString).GetFirstRowColumnAsValue("FavoriteCount", 0);
            }
        }
        ...
        public static DataTable recent_users(
            string connectionString, [NotNull] object boardID, int timeSinceLastLogin, [NotNull] object styledNicks)
        {
        ...
        /// The tracking id.
        /// </param>
        public static void ReadForum_delete(string connectionString, [NotNull] object trackingID)
        {
        ...
        private static DataTable db_index_simplelist(string connectionString)
        {
        ...
        public static void CreateDatabase(string connectionString, bool embeded)
        {
        ...
        public static void AddProfileColumn(
            string connectionString, [NotNull] string name, FbDbType columnType, int size)
        {
            // get column type...
        ...
        public static DataTable admin_list(
            string connectionString, [NotNull] object boardId, [NotNull] object useStyledNicks)
        {
        ...
        public static void unencode_all_topics_subjects(
            string connectionString, [NotNull] Func<string, string> decodeTopicFunc)
        {
            var topics =
