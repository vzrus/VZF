...
namespace YAF.Classes.Data.MsSql
{
    ...
    public static class LegacyDb
    {
        ...
        public static int GetDBSize(string connectionString)
        {
            using (var cmd = new SqlCommand("select sum(cast(size as integer))/128 from sysfiles"))
            {
                ...
                return (int) MsSqlDbAccess.Current.ExecuteScalar(cmd,connectionString);
            }
        }
          ...
          bool searchDisplayName)
        {
            ...
            {
                return MsSqlDbAccess.Current.GetData(cmd,connectionString);
            }
        }
        ...
        public static IEnumerable<TypedMailList> MailList(string connectionString, long processId)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("mail_list"))
            {
                ...
                return MsSqlDbAccess.Current.GetData(cmd,connectionString).SelectTypedList(x => new TypedMailList(x));
            }
        }
        ...
        public static IEnumerable<TypedAllThanks> MessageGetAllThanks(string connectionString, [NotNull] string messageIdsSeparatedWithColon)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("message_getallthanks"))
            {
                ...
                return MsSqlDbAccess.Current.GetData(cmd,connectionString).AsEnumerable().Select(t => new TypedAllThanks(t));
            }
        }
        ...
        public static IEnumerable<TypedMessageList> MessageList(string connectionString, int messageID)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("message_list"))
            {
                ...
                return MsSqlDbAccess.Current.GetData(cmd,connectionString).AsEnumerable().Select(t => new TypedMessageList(t));
            }
        }
        ...
        public static IEnumerable<TypedPollGroup> PollGroupList(string connectionString, int userID, int? forumId, int boardId)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("pollgroup_list"))
            {
                ...
                return MsSqlDbAccess.Current.GetData(cmd,connectionString).AsEnumerable().Select(r => new TypedPollGroup(r));
            }
        }
        ...
        public static IEnumerable<TypedSmileyList> SmileyList(string connectionString, int boardID, int? smileyID)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("smiley_list"))
            {
                ...
                return MsSqlDbAccess.Current.GetData(cmd,connectionString).AsEnumerable().Select(r => new TypedSmileyList(r));
            }
        }
            ...
            using (
              var cmd =
                MsSqlDbAccess.GetCommand(
                  ...
                  true))
            {
                return Convert.ToUInt16(MsSqlDbAccess.Current.ExecuteScalar(cmd,connectionString));
            }
        }
        ...
        public static int TopicFavoriteCount(string connectionString, int topicId)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("topic_favorite_count"))
            {
                ...
                return MsSqlDbAccess.Current.GetData(cmd,connectionString).GetFirstRowColumnAsValue("FavoriteCount", 0);
            }
        }
        ...
        /// </returns>
        [NotNull]
        public static IEnumerable<TypedUserFind> UserFind(string connectionString,
          int boardID,
          bool filter, [NotNull] string userName, [NotNull] string email, [NotNull] string displayName, [NotNull] object notificationType, [NotNull] object dailyDigest)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("user_find"))
            {
                ...
                return MsSqlDbAccess.Current.GetData(cmd,connectionString).AsEnumerable().Select(u => new TypedUserFind(u));
            }
        }
          ...
          int boardID, int? userID, bool? approved, int? groupID, int? rankID, bool? useStyledNicks)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("user_list"))
            {
                ...
                return MsSqlDbAccess.Current.GetData(cmd,connectionString).AsEnumerable().Select(x => new TypedUserList(x));
            }
        }
        ...
        public static bool accessmask_delete(string connectionString, [NotNull] object accessMaskID)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("accessmask_delete"))
            {
                ...
                return (int)MsSqlDbAccess.Current.ExecuteScalar(cmd,connectionString) != 0;
            }
        }
        ...
        /// <returns>
        /// </returns>
        public static DataTable accessmask_list(string connectionString, [NotNull] object boardID, [NotNull] object accessMaskID)
        {
        ...
        public static void accessmask_save(string connectionString, [NotNull] object accessMaskID, [NotNull] object boardID, [NotNull] object name, [NotNull] object readAccess, [NotNull] object postAccess, [NotNull] object replyAccess, [NotNull] object priorityAccess, [NotNull] object pollAccess, [NotNull] object voteAccess, [NotNull] object moderatorAccess, [NotNull] object editAccess, [NotNull] object deleteAccess, [NotNull] object uploadAccess, [NotNull] object downloadAccess, [NotNull] object sortOrder)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("accessmask_save"))
            {
                ...
                MsSqlDbAccess.Current.ExecuteNonQuery(cmd,connectionString);
            }
        }
        ...
        public static DataRow active_stats(string connectionString, [NotNull] object boardID)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("active_stats"))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("BoardID", boardID);
                using (DataTable dt = MsSqlDbAccess.Current.GetData(cmd,connectionString))
                {
                    return dt.Rows[0];
                }
            }
        ...
        public static void attachment_delete(string connectionString, [NotNull] object attachmentID)
        {
            ...
            if (!useFileTable)
            {
                using (var cmd = MsSqlDbAccess.GetCommand("attachment_list"))
                {
                    ...
                    DataTable tbAttachments = MsSqlDbAccess.Current.GetData(cmd,connectionString);
        ...
        public static DataRow board_poststats(string connectionString, int? boardId, bool useStyledNick, bool showNoCountPosts)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("board_poststats"))
            {
                ...
                DataTable dt = MsSqlDbAccess.Current.GetData(cmd,connectionString);
                if (dt.Rows.Count > 0)
                {
                    return dt.Rows[0];
                }
        ...
        /// The description.
        /// </param>
        public static void eventlog_create(string connectionString, [NotNull] object userID, [NotNull] object source, [NotNull] object description)
        {
            eventlog_create(connectionString,userID, source.GetType().ToString(), description, 0);
        }
        ...
        /// </param>
        public static void eventlog_delete(string connectionString, [NotNull] object eventLogID, int pageUserId)
        {
        ...
        /// </returns>
        public static DataTable extension_list(string connectionString, [NotNull] object boardID)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("extension_list"))
            {
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public static bool forum_delete(string connectionString, [NotNull] object forumID)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("forum_listSubForums"))
            {
                ...
                if (!(MsSqlDbAccess.Current.ExecuteScalar(cmd,connectionString) is DBNull))
                {
                    return false;
                }
                ...
                using (SqlCommand cmd_new = MsSqlDbAccess.GetCommand("forum_delete"))
                {
                    ...
                    MsSqlDbAccess.Current.ExecuteNonQuery(cmd_new,connectionString);
                }
        ...
        public static int forum_maxid(string connectionString, [NotNull] object boardID)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("forum_maxid"))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("BoardID", boardID);
                return Convert.ToInt32(MsSqlDbAccess.Current.ExecuteScalar(cmd,connectionString));
            }
        }
        ...
        /// </returns>
        public static DataTable forum_listall(string connectionString, [NotNull] object boardID, [NotNull] object userID)
        {
        ...
        /// DataTable of all accessible forums
        /// </returns>
        public static DataTable forum_listall(string connectionString, [NotNull] object boardID, [NotNull] object userID, [NotNull] object startAt)
        {
        ...
        /// DataTable with list
        /// </returns>
        public static DataTable forum_listall_fromCat(string connectionString, [NotNull] object boardID, [NotNull] object categoryID)
        {
        ...
        /// <returns>
        /// </returns>
        public static DataTable forum_listall_sorted(string connectionString, [NotNull] object boardID, [NotNull] object userID)
        {
            return !MsSqlDbAccess.LargeForumTree ? forum_listall_sorted(connectionString,boardID, userID, null, false, 0) : forum_ns_getchildren_activeuser(connectionString,(int)boardID, 0, 0, (int)userID, false, false, "-");
        }
        ...
        /// <returns>
        /// </returns>
        public static DataTable forum_listall_sorted(string connectionString, [NotNull] object boardID, [NotNull] object userID, [NotNull] int[] forumidExclusions)
        {
        ...
        /// </returns>
        [NotNull]
        public static DataTable forum_listall_sorted(string connectionString, [NotNull] object boardID, [NotNull] object userID, [NotNull] int[] forumidExclusions, bool emptyFirstRow, int startAt)
        {
        ...
        /// BoardID
        /// </param>
        public static void forum_resync(string connectionString, [NotNull] object boardID)
        {
          ...
          bool dummy)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("forum_save"))
            {
                ...
                cmd.Parameters.AddWithValue("AccessMaskID", accessMaskID);
                return long.Parse(MsSqlDbAccess.Current.ExecuteScalar(cmd,connectionString).ToString());
            }
        }
        ...
        public static DataTable forumaccess_group(string connectionString, [NotNull] object groupID)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("forumaccess_group"))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("GroupID", groupID);
                return userforumaccess_sort_list(connectionString,MsSqlDbAccess.Current.GetData(cmd,connectionString), 0, 0, 0);
            }
        }
        ...
        public static string forumpage_validateversion(string connectionString, int appVersion)
        {
            ...
            try
            {
                DataTable registry = registry_list(connectionString,"Version");
        ...
        /// </param>
        public static void medal_delete(string connectionString, [NotNull] object boardID, [NotNull] object category)
        {
        ...
        /// ID of medal to list.
        /// </param>
        public static DataTable medal_list(string connectionString, [NotNull] object medalID)
        {
        ...
        /// </param>
        public static DataTable medal_list(string connectionString, [NotNull] object boardID, [NotNull] object category)
        {
        ...
        /// </returns>
        [NotNull]
        public static string message_AddThanks(string connectionString, [NotNull] object FromUserID, [NotNull] object MessageID, bool useDisplayName)
        {
        ...
        /// </returns>
        [NotNull]
        public static string message_RemoveThanks(string connectionString, [NotNull] object FromUserID, [NotNull] object MessageID, bool useDisplayName)
        {
        ...
        /// The delete linked.
        /// </param>
        public static void message_delete(string connectionString,[NotNull] object messageID, bool isModeratorChanged, [NotNull] string deleteReason, int isDeleteAction, bool DeleteLinked)
        {
        ...
        public static DataTable message_getRepliesList(string connectionString,[NotNull] object messageID)
        {
            ...
            using (var cmd = MsSqlDbAccess.GetCommand("message_reply_list"))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("MessageID", messageID);
                DataTable dtr = MsSqlDbAccess.Current.GetData(cmd,connectionString);
        ...
        public static void message_move(string connectionString,[NotNull] object messageID, [NotNull] object moveToTopic, bool moveAll)
        {
            ...
            if (moveAll)
            {
                using (var cmd = MsSqlDbAccess.GetCommand("message_getReplies"))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("MessageID", messageID);
                    DataTable tbReplies = MsSqlDbAccess.Current.GetData(cmd,connectionString);
        ...
        public static IEnumerable<TypedNntpForum> NntpForumList(string connectionString,int boardID, int? minutes, int? nntpForumID, bool? active)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("nntpforum_list"))
            {
                ...
                return MsSqlDbAccess.Current.GetData(cmd,connectionString).AsEnumerable().Select(r => new TypedNntpForum(r));
            }
        }
        ...
        public static void pmessage_archive(string connectionString,[NotNull] object userPMessageID)
        {
            using (SqlCommand sqlCommand = MsSqlDbAccess.GetCommand("pmessage_archive"))
            {
                ...
                MsSqlDbAccess.Current.ExecuteNonQuery(sqlCommand,connectionString);
            }
        }
        ...
        /// <param name="userPMessageID">
        /// </param>
        public static void pmessage_delete(string connectionString,[NotNull] object userPMessageID)
        {
        ...
        /// <returns>
        /// </returns>
        public static DataTable pmessage_list(string connectionString,[NotNull] object userPMessageID)
        {
        ...
        public static int? poll_save(string connectionString,[NotNull] List<PollSaveList> pollList)
        {
            foreach (PollSaveList question in pollList)
            {
                ...
                using (var cmd = MsSqlDbAccess.GetCommand(sb.ToString(), true))
                {
                    ...
                    MsSqlDbAccess.Current.ExecuteNonQuery(cmd,true,connectionString);
        ...
        /// <returns>
        /// </returns>
        public static DataTable rsstopic_list(string connectionString, int forumId, int start, int topicLimit)
        {
        ...
        /// The topic id.
        /// </param>
        public static void topic_delete(string connectionString,[NotNull] object topicID)
        {
        ...
        public static DataTable topic_list(string connectionString,[NotNull] object forumID, [NotNull] object userId, [NotNull] object sinceDate, [NotNull] object toDate, [NotNull] object pageIndex, [NotNull] object pageSize, [NotNull] object useStyledNicks, [NotNull] object showMoved, [CanBeNull]bool findLastRead)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("topic_list"))
            {
                ...
                cmd.Parameters.AddWithValue("FindLastRead", findLastRead);
                return MsSqlDbAccess.Current.GetData(cmd,true,connectionString);
            }
        }
        ...
        public static int user_ThankFromCount(string connectionString,[NotNull] object userId)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("user_thankfromcount"))
            {
                ...
                var thankCount = (int)MsSqlDbAccess.Current.ExecuteScalar(cmd,connectionString);
        ...
        public static bool user_RepliedTopic(string connectionString,[NotNull] object messageId, [NotNull] object userId)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("user_repliedtopic"))
            {
                ...
                var messageCount = (int)MsSqlDbAccess.Current.ExecuteScalar(cmd,connectionString);
        ...
        public static bool user_changepassword(string connectionString,[NotNull] object userID, [NotNull] object oldPassword, [NotNull] object newPassword)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("user_changepassword"))
            {
                ...
                return (bool)MsSqlDbAccess.Current.ExecuteScalar(cmd,connectionString);
            }
        }
        ...
        public static string user_getsignature(string connectionString, [NotNull] object userID)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("user_getsignature"))
            {
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("UserID", userID);
                return MsSqlDbAccess.Current.ExecuteScalar(cmd,connectionString).ToString();
            }
        }
        ...
        public static int? user_guest(string connectionString, [NotNull] object boardID)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("user_guest"))
            {
                ...
                cmd.Parameters.AddWithValue("BoardID", boardID);
                cmd.Parameters.AddWithValue("UTCTIMESTAMP", DateTime.UtcNow);
                return MsSqlDbAccess.Current.ExecuteScalar(cmd,connectionString).ToType<int?>();
            }
        }
            ...
            while (true)
            {
                try
                {
                    using (var cmd = MsSqlDbAccess.GetCommand("user_lazydata"))
                    {
                        ...
                        return MsSqlDbAccess.Current.GetData(cmd,connectionString).Rows[0];
                    }
                }
                catch (SqlException x)
                {
        ...
        /// <returns>
        /// </returns>
        public static DataTable user_list(string connectionString, [NotNull] object boardID, [NotNull] object userID, [NotNull] object approved)
        {
        ...
        /// <returns>
        /// </returns>
        public static DataTable user_list(string connectionString, [NotNull] object boardID, [NotNull] object userID, [NotNull] object approved, [NotNull] object useStyledNicks)
        {
        ...
        /// <returns>
        /// </returns>
        public static DataTable user_list(string connectionString, [NotNull] object boardID, [NotNull] object userID, [NotNull] object approved, [NotNull] object groupID, [NotNull] object rankID)
        {
            return user_list(connectionString,boardID, userID, approved, null, null, false);
        }
        ...
        public static DataTable User_ListProfilesByIdsList(string connectionString, [NotNull] int boardID, [NotNull] int[] userIdsList, [CanBeNull] object useStyledNicks)
        {
            ...
            {
                LegacyDb.eventlog_create(connectionString,null, e.Source, e.Message, EventLogTypes.Error);
            }
        ...
        public static object user_login(string connectionString, [NotNull] object boardID, [NotNull] object name, [NotNull] object password)
        {
            using (var cmd = MsSqlDbAccess.GetCommand("user_login"))
            {
                ...
                return MsSqlDbAccess.Current.ExecuteScalar(cmd,connectionString);
            }
        }
        ...
        public static DateTime? User_LastRead(string connectionString, [NotNull] object userID)
        {
					using (var cmd = MsSqlDbAccess.GetCommand("user_lastread"))
            {
                ...
                var tableLastRead = MsSqlDbAccess.Current.ExecuteScalar(cmd,connectionString);
    ...
    /// </exception>
        ...
        {
            using (DataTable dt = registry_list(connectionString,name))
            {
        ...
        /// </param>
        private static void eventlog_delete(string connectionString, [NotNull] object eventLogID, [NotNull] object boardID, [NotNull] object pageUserID)
        {
        ...
        /// <returns>
        /// </returns>
        private static DataTable forum_sort_list(string connectionString,[NotNull] DataTable listSource, int parentID, int categoryID, int startingIndent, [NotNull] int[] forumidExclusions)
        {
        ...
        /// </param>
        private static void medal_delete(string connectionString,[NotNull] object boardID, [NotNull] object medalID, [NotNull] object category)
        {
        ...
        /// </returns>
        private static DataTable medal_list(string connectionString,[NotNull] object boardID, [NotNull] object medalID, [NotNull] object category)
        {
        ...
        private static void message_moveRecursively(string connectionString, [NotNull] object messageID, [NotNull] object moveToTopic)
        {
            ...
            using (var cmd = MsSqlDbAccess.GetCommand("message_getReplies"))
            {
                ...
                using (SqlCommand innercmd = MsSqlDbAccess.GetCommand("message_move"))
                {
                    ...
                    MsSqlDbAccess.Current.ExecuteNonQuery(innercmd,connectionString);
                }
            }
        }
        ...
        private static void userforumaccess_sort_list_recursive(string connectionString, [NotNull] DataTable listSource, [NotNull] DataTable listDestination, int parentID, int categoryID, int currentIndent)
        {
            foreach (DataRow row in listSource.Rows)
            {
                ...
                if ((int)row["ParentID"] == parentID)
                {
                    ...
                    // recurse through the list...
                    userforumaccess_sort_list_recursive(connectionString,
