...
namespace YAF.Classes.Data
{
  ...
  public class MsSqlDbAccess : IDbAccess
  {
    ...
    /// </returns>
    public static bool TestConnection([NotNull]string connectionString, [NotNull] out string exceptionMessage)
    {
    ...
    /// The transaction.
    /// </param>
    public void ExecuteNonQuery([NotNull] IDbCommand cmd, bool transaction, string connectionString)
    {
    ...
    public DataTable GetDataTableFromReader([NotNull] IDbCommand cmd, bool transaction, bool acceptChanges, string connectionString)
    {
        throw new Exception("Not in use for the data layer.");
    }
    ...
    /// <returns>
    /// </returns>
    public DataTable GetData([NotNull] IDbCommand cmd, bool transaction, string connectionString)
    {
      using (var qc = new QueryCounter(cmd.CommandText))
      {
    ...
    /// <returns>
    /// </returns>
    public DataTable GetData([NotNull] string commandText, bool transaction, string connectionString)
    {
