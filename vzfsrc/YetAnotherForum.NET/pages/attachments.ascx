...
<table class="content" width="100%" cellspacing="1" cellpadding="0">
	...
	<tr id="selectfiletr" runat="server">
		...
		<td class="post">
            ...
            <asp:TextBox ID="textBoxUrl" runat="server"></asp:TextBox><asp:Button runat="server" CssClass="pbutton" ID="buttonDownload" OnClick="Back_Click" />
		<asp:TextBox ID="progressBar" runat="server"></asp:TextBox><asp:Label ID="labelStatus" runat="server"></asp:Label>
        </td>
	</tr>
	<tr>
		<td class="header2">
