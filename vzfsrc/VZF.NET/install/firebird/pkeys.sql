...
EXECUTE STATEMENT 'ALTER TABLE objQual_TAGS ADD CONSTRAINT PK_TAGS_TAG PRIMARY KEY (TAGID);';
END
--GO
...
EXECUTE STATEMENT 'ALTER TABLE objQual_TOPICTAGS ADD CONSTRAINT PK_TOPICTAGS_TAGIDTOPICID PRIMARY KEY (TAGID,TOPICID);';
END
--GO
