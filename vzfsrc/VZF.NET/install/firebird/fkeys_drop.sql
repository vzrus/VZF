...
--GO
EXECUTE PROCEDURE DP_DROP_FKEY_PROC('objQual_GROUPHISTORY', 'FK_objQual_GROUPHISTORY_GROUPID');
--GO
EXECUTE PROCEDURE DP_DROP_FKEY_PROC('objQual_FORUMHISTORY', 'FK_objQual_FORUMHISTORY_FORUMID');
--GO
EXECUTE PROCEDURE DP_DROP_FKEY_PROC('objQual_ACCESSMASKHISTORY', 'FK_objQual_ACCESSMASKHISTORY_ACCESSMASKID');
--GO
