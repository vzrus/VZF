...
AS
BEGIN
-- Source foreign key: FK_objQual_TAGS_TOPICTAGS
  IF (NOT EXISTS(
    SELECT 1 FROM RDB$RELATION_CONSTRAINTS RC
    WHERE (RC.RDB$CONSTRAINT_NAME = 'FK_objQual_TAGS_TOPICTAGS') 
    AND (RC.RDB$RELATION_NAME = 'objQual_TOPICTAGS')
        AND (RC.RDB$CONSTRAINT_TYPE = 'FOREIGN KEY')
  )) THEN
  EXECUTE STATEMENT 'ALTER TABLE objQual_TOPICTAGS ADD CONSTRAINT FK_objQual_TAGS_TOPICTAGS FOREIGN KEY (TAGID) REFERENCES objQual_TAGS(TAGID) ON DELETE CASCADE ON UPDATE NO ACTION;';
END
--GO
...
AS
BEGIN
-- Source foreign key: FK_objQual_TOPIC_TOPICTAGS
  IF (NOT EXISTS(
    SELECT 1 FROM RDB$RELATION_CONSTRAINTS RC
    WHERE (RC.RDB$CONSTRAINT_NAME = 'FK_objQual_TOPIC_TOPICTAGS') 
    AND (RC.RDB$RELATION_NAME = 'objQual_TOPICTAGS')
        AND (RC.RDB$CONSTRAINT_TYPE = 'FOREIGN KEY')
  )) THEN
  EXECUTE STATEMENT 'ALTER TABLE objQual_TOPICTAGS ADD CONSTRAINT FK_objQual_TOPIC_TOPICTAGS FOREIGN KEY (TOPICID) REFERENCES objQual_TOPIC(TOPICID) ON DELETE CASCADE ON UPDATE NO ACTION;';
END
--GO
...
BEGIN
  IF (NOT EXISTS(
    SELECT 1 FROM RDB$RELATION_CONSTRAINTS RC
    WHERE (RC.RDB$CONSTRAINT_NAME = 'FK_objQual_GROUPHISTORY_GROUPID') 
    AND (RC.RDB$RELATION_NAME = 'objQual_GROUPHISTORY')
        AND (RC.RDB$CONSTRAINT_TYPE = 'FOREIGN KEY')
  )) THEN
  EXECUTE STATEMENT 'ALTER TABLE objQual_GROUPHISTORY 
   ADD CONSTRAINT FK_objQual_GROUPHISTORY_GROUPID 
   FOREIGN KEY (GROUPID) REFERENCES objQual_GROUP(GROUPID) 
   ON DELETE CASCADE ON UPDATE NO ACTION;';
END
--GO
...
BEGIN
  IF (NOT EXISTS(
    SELECT 1 FROM RDB$RELATION_CONSTRAINTS RC
    WHERE (RC.RDB$CONSTRAINT_NAME = 'FK_objQual_FORUMHISTORY_FORUMID') 
    AND (RC.RDB$RELATION_NAME = 'objQual_FORUMHISTORY')
        AND (RC.RDB$CONSTRAINT_TYPE = 'FOREIGN KEY')
  )) THEN
  EXECUTE STATEMENT 'ALTER TABLE objQual_FORUMHISTORY 
   ADD CONSTRAINT FK_objQual_FORUMHISTORY_FORUMID 
   FOREIGN KEY (GROUPID) REFERENCES objQual_FORUM(FORUMID) 
   ON DELETE CASCADE ON UPDATE NO ACTION;';
END
--GO
...
BEGIN
  IF (NOT EXISTS(
    SELECT 1 FROM RDB$RELATION_CONSTRAINTS RC
    WHERE (RC.RDB$CONSTRAINT_NAME = 'FK_objQual_ACCESSMASKHISTORY_ACCESSMASKID') 
    AND (RC.RDB$RELATION_NAME = 'objQual_ACCESSMASKHISTORY')
        AND (RC.RDB$CONSTRAINT_TYPE = 'FOREIGN KEY')
  )) THEN
  EXECUTE STATEMENT 'ALTER TABLE objQual_ACCESSMASKHISTORY 
   ADD CONSTRAINT FK_objQual_ACCESSMASKHISTORY_ACCESSMASKID 
   FOREIGN KEY (ACCESSMASKID) REFERENCES objQual_ACCESSMASK(ACCESSMASKID) 
   ON DELETE CASCADE ON UPDATE NO ACTION;';
END
--GO
