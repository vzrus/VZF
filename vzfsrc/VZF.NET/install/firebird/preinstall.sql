...
FROM RDB$PROCEDURES a WHERE a.RDB$PROCEDURE_NAME='DROP_PROCEDURE')) THEN
EXECUTE STATEMENT 'DROP PROCEDURE DROP_PROCEDURE;';  
END
--GO
...
BEGIN
IF (EXISTS(SELECT FIRST 1 1 
FROM RDB$PROCEDURES a WHERE a.RDB$PROCEDURE_NAME='DP_DROP_TRIGGER_PROC')) THEN
EXECUTE STATEMENT 'DROP PROCEDURE DP_DROP_TRIGGER_PROC;';  
END
--GO
...
BEGIN
IF (EXISTS(SELECT FIRST 1 1 
FROM RDB$PROCEDURES a WHERE a.RDB$PROCEDURE_NAME='DP_DROP_INDEX_PROC')) THEN
EXECUTE STATEMENT 'DROP PROCEDURE DP_DROP_INDEX_PROC;';  
END
--GO
...
BEGIN
IF (EXISTS(SELECT FIRST 1 1 
FROM RDB$PROCEDURES a WHERE a.RDB$PROCEDURE_NAME='DP_DROP_UKEY_PROC')) THEN
EXECUTE STATEMENT 'DROP PROCEDURE DP_DROP_UKEY_PROC;';  
END
--GO
...
BEGIN
IF (EXISTS(SELECT FIRST 1 1 
FROM RDB$PROCEDURES a WHERE a.RDB$PROCEDURE_NAME='DP_DROP_TABLE_PROC')) THEN
EXECUTE STATEMENT 'DROP PROCEDURE DP_DROP_TABLE_PROC;';  
END
--GO
...
BEGIN
IF (EXISTS(SELECT FIRST 1 1 
FROM RDB$PROCEDURES a WHERE a.RDB$PROCEDURE_NAME='DP_DROP_PKEY_PROC')) THEN
EXECUTE STATEMENT 'DROP PROCEDURE DP_DROP_PKEY_PROC;';  
END
--GO
...
BEGIN
IF (EXISTS(SELECT FIRST 1 1 
FROM RDB$PROCEDURES a WHERE a.RDB$PROCEDURE_NAME='DP_DROP_FKEY_PROC')) THEN
EXECUTE STATEMENT 'DROP PROCEDURE DP_DROP_FKEY_PROC;';  
END
--GO
