...
IF (NOT EXISTS(SELECT 1 
    ...
    EXECUTE STATEMENT 'CREATE TABLE objQual_ACCESSMASK
                       ...
                       CREATEDBYUSERNAME    VARCHAR(255) CHARACTER SET UTF8  NULL COLLATE UNICODE,
                       CREATEDBYUSERDISPLAYNAME  VARCHAR(255) CHARACTER SET UTF8  NULL COLLATE UNICODE,
...
IF (NOT EXISTS( SELECT 1 FROM RDB$RELATION_FIELDS
    ...
    EXECUTE STATEMENT 'ALTER TABLE objQual_GROUP ADD CREATEDBYUSERNAME  VARCHAR(255) CHARACTER SET UTF8  NULL COLLATE UNICODE;';

IF (NOT EXISTS( SELECT 1 FROM RDB$RELATION_FIELDS
                WHERE RDB$RELATION_FIELDS.RDB$RELATION_NAME = UPPER('objQual_GROUP')
                AND RDB$RELATION_FIELDS.RDB$FIELD_NAME = UPPER('CREATEDBYUSERDISLAYNAME') ROWS 1)) THEN
    EXECUTE STATEMENT 'ALTER TABLE objQual_GROUP ADD CREATEDBYUSERDISLAYNAME  VARCHAR(255) CHARACTER SET UTF8  NULL COLLATE UNICODE;';
IF (NOT EXISTS( SELECT 1 FROM RDB$RELATION_FIELDS
                WHERE RDB$RELATION_FIELDS.RDB$RELATION_NAME = UPPER('objQual_GROUP')
                AND RDB$RELATION_FIELDS.RDB$FIELD_NAME = UPPER('CREATEDDATE') ROWS 1)) THEN
    EXECUTE STATEMENT 'ALTER TABLE objQual_GROUP ADD CREATEDDATE TIMESTAMP NULL';
...
IF (NOT EXISTS( SELECT 1 FROM RDB$RELATION_FIELDS
                WHERE RDB$RELATION_FIELDS.RDB$RELATION_NAME = UPPER('objQual_FORUM')
                AND RDB$RELATION_FIELDS.RDB$FIELD_NAME = UPPER('CREATEDBYUSERNAME') ROWS 1)) THEN
    EXECUTE STATEMENT 'ALTER TABLE objQual_FORUM ADD CREATEDBYUSERNAME  VARCHAR(255) CHARACTER SET UTF8  NULL COLLATE UNICODE;';

IF (NOT EXISTS( SELECT 1 FROM RDB$RELATION_FIELDS
                WHERE RDB$RELATION_FIELDS.RDB$RELATION_NAME = UPPER('objQual_FORUM')
                AND RDB$RELATION_FIELDS.RDB$FIELD_NAME = UPPER('CREATEDBYUSERDISLAYNAME') ROWS 1)) THEN
    EXECUTE STATEMENT 'ALTER TABLE objQual_FORUM ADD CREATEDBYUSERDISLAYNAME  VARCHAR(255) CHARACTER SET UTF8  NULL COLLATE UNICODE;';

IF (NOT EXISTS( SELECT 1 FROM RDB$RELATION_FIELDS
                WHERE RDB$RELATION_FIELDS.RDB$RELATION_NAME = UPPER('objQual_FORUM')
                AND RDB$RELATION_FIELDS.RDB$FIELD_NAME = UPPER('CREATEDDATE') ROWS 1)) THEN
    EXECUTE STATEMENT 'ALTER TABLE objQual_FORUM ADD CREATEDDATE  TIMESTAMP NULL';
...
IF (NOT EXISTS( SELECT 1 FROM RDB$RELATION_FIELDS
                WHERE RDB$RELATION_FIELDS.RDB$RELATION_NAME = UPPER('objQual_ACCESSMASK')
                AND RDB$RELATION_FIELDS.RDB$FIELD_NAME = UPPER('CREATEDBYUSERNAME') ROWS 1)) THEN
    EXECUTE STATEMENT 'ALTER TABLE objQual_ACCESSMASK ADD CREATEDBYUSERNAME  VARCHAR(255) CHARACTER SET UTF8  NULL COLLATE UNICODE;';

IF (NOT EXISTS( SELECT 1 FROM RDB$RELATION_FIELDS
                WHERE RDB$RELATION_FIELDS.RDB$RELATION_NAME = UPPER('objQual_ACCESSMASK')
                AND RDB$RELATION_FIELDS.RDB$FIELD_NAME = UPPER('CREATEDBYUSERDISLAYNAME') ROWS 1)) THEN
    EXECUTE STATEMENT 'ALTER TABLE objQual_ACCESSMASK ADD CREATEDBYUSERDISLAYNAME  VARCHAR(255) CHARACTER SET UTF8  NULL COLLATE UNICODE;';

IF (NOT EXISTS( SELECT 1 FROM RDB$RELATION_FIELDS
                WHERE RDB$RELATION_FIELDS.RDB$RELATION_NAME = UPPER('objQual_ACCESSMASK')
                AND RDB$RELATION_FIELDS.RDB$FIELD_NAME = UPPER('CREATEDDATE') ROWS 1)) THEN
    EXECUTE STATEMENT 'ALTER TABLE objQual_ACCESSMASK ADD CREATEDDATE  TIMESTAMP NULL';
