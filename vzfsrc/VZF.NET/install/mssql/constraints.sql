...
if not exists (select top 1 1 from  sys.indexes  where object_id = object_id('[{databaseOwner}].[{objectQualifier}AccessMaskHistory]') and name='PK_{objectQualifier}AccessMaskHistory')
...
if not exists (select top 1 1 from  sys.indexes  where object_id = object_id('[{databaseOwner}].[{objectQualifier}ForumHistory]') and name='PK_{objectQualifier}ForumHistory')
...
if not exists (select top 1 1 from  sys.indexes  where object_id = object_id('[{databaseOwner}].[{objectQualifier}GroupHistory]') and name='PK_{objectQualifier}GroupHistory')
...
if not exists (select top 1 1 from  sys.objects where name='FK_{objectQualifier}AccessMaskHistory_{objectQualifier}AccessMask' and parent_object_id=object_id('[{databaseOwner}].[{objectQualifier}AccessMaskHistory]') and type in (N'F'))
...
if not exists (select top 1 1 from  sys.objects where name='FK_{objectQualifier}GroupHistory_{objectQualifier}Group' and parent_object_id=object_id('[{databaseOwner}].[{objectQualifier}GroupHistory]') and type in (N'F'))
...
if not exists (select top 1 1 from  sys.objects where name='FK_{objectQualifier}ForumHistory_{objectQualifier}Forum' and parent_object_id=object_id('[{databaseOwner}].[{objectQualifier}ForumHistory]') and type in (N'F'))
...
if not exists (select top 1 1 from  sys.objects where name='FK_{objectQualifier}TopicTags_{objectQualifier}Tags' and parent_object_id=object_id('[{databaseOwner}].[{objectQualifier}TopicTags]') and type in (N'F'))
...
if not exists (select top 1 1 from  sys.objects where name='FK_{objectQualifier}TopicTags_{objectQualifier}Topic' and parent_object_id=object_id('[{databaseOwner}].[{objectQualifier}TopicTags]') and type in (N'F'))
