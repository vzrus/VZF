  ...
  <table class="content" cellspacing="1" cellpadding="0" width="100%">
        <tr>
            <td class="header1" colspan="13">
                  <YAF:LocalizedLabel ID="LocalizedLabel14" runat="server" LocalizedTag="TITLE" LocalizedPage="ADMIN_ACCESSMASKS" />
            </td>
        </tr>
        <tr class="header2">
            <td>
        ...
        <asp:Repeater ID="List" runat="server" OnItemCommand="AccessMaskList_ItemCommand">
            <ItemTemplate>
                ...
                <YAF:LocalizedLabel ID="LocalizedLabel16" runat="server" LocalizedTag="CREATEUSERFORUM"  LocalizedPage="ADMIN_ACCESSMASKS" />&nbsp;
