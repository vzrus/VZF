									...
									<tr class="postheader">
										<td class="small" align="left" colspan="2">
                                            ...
                                            <a href='<%# YafBuildLink.GetLink(ForumPages.posts,"m={0}#post{0}",Container.DataItemToField<int>("MessageID")) %>'>
												<VZF:ThemeImage ID="ThisPostImage" ThemeTag="ICON_LATEST" LocalizedTitle='<%# this.GetText("DEFAULT", "GO_LAST_POST") %>' UseTitleForEmptyAlt="true"  runat="server" Style="border: 0" />
                                            </a>
											<br />
											<strong>
