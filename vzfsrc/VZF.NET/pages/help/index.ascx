...
<VZF:HelpMenu runat="server">
	<table class="content" width="100%" cellspacing="1" cellpadding="0">
        <tr>
			<td class="header1">
                <VZF:LocalizedLabel ID="Title" runat="server" LocalizedTag="title" LocalizedPage="HELP_INDEX" />
			</td>
		</tr>
        ...
        <tr>
            <td class="header2">
				<VZF:LocalizedLabel ID="SearchHelpTitle" runat="server" LocalizedTag="searchhelptitle" />
			</td>
        </tr>
		<tr>
			<td class="post">
			    <VZF:LocalizedLabel ID="SearchFor" runat="server" LocalizedTag="searchfor" />&nbsp;
