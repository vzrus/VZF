...
<div align="center">
	<table class="content" width="600" cellspacing="1" cellpadding="0" id="approved"
		...
		<tr>
			<td class="post" colspan="2" align="center">
				<VZF:LocalizedLabel ID="LocalizedLabel2" runat="server" LocalizedTag="email_verified" />
			</td>
		</tr>
	</table>
	<table class="content" width="600" cellspacing="1" cellpadding="0" id="error" runat="server"
		...
		<tr>
			<td class="header1" colspan="2">
				<VZF:LocalizedLabel ID="LocalizedLabel3" runat="server" LocalizedTag="title" />
			</td>
		</tr>
		<tr>
			<td class="header2" colspan="2" align="center">
				<VZF:LocalizedLabel ID="LocalizedLabel4" runat="server" LocalizedTag="email_verify_failed" />
			</td>
		</tr>
		<tr>
			<td class="postheader" width="50%">
				<VZF:LocalizedLabel ID="LocalizedLabel5" runat="server" LocalizedTag="enter_key" />
				:</td>
