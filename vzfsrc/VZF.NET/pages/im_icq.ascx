...
<table class="content" width="600" border="0" cellpadding="0" cellspacing="1">
	<tr>
		<td colspan="2" class="header1">
			<img runat="server" id="Status" style="vertical-align: middle" alt="" /><VZF:LocalizedLabel
				ID="LocalizedLabel1" runat="server" LocalizedTag="TITLE" />
		</td>
	</tr>
	<tr>
		<td class="postheader">
			<VZF:LocalizedLabel ID="LocalizedLabel2" runat="server" LocalizedTag="NAME" />
		</td>
		<td class="post">
	...
	<tr>
		<td class="postheader">
			<VZF:LocalizedLabel ID="LocalizedLabel3" runat="server" LocalizedTag="EMAIL" />
		</td>
		<td class="post">
	...
	<tr>
		<td class="postheader" valign='top'>
			<VZF:LocalizedLabel ID="LocalizedLabel4" runat="server" LocalizedTag="BODY" />
		</td>
		<td class="post">
