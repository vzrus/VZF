...
<asp:Repeater ID="List" runat="server">
        ...
        <table class="content" cellspacing="1" cellpadding="0" width="100%">
            <tr>
                <td colspan="2" class="header1" align="left">
                    <VZF:LocalizedLabel runat="server" LocalizedTag="UNAPPROVED" />
                </td>
            </tr>
    </HeaderTemplate>
    <FooterTemplate>
    ...
    <ItemTemplate>
        ...
        <tr class="postheader">
            <td>
                <VZF:UserLink ID="UserName" runat="server" UserID='<%# Convert.ToInt32(Eval("UserID")) %>' />
            </td>
            <td>
                <b>Posted:</b>
        ...
        <tr class="postfooter">
            ...
            <td class="postfooter" style="float: left">
                <VZF:ThemeButton ID="ApproveBtn" runat="server" CssClass="yaflittlebutton" TextLocalizedPage="MODERATE_FORUM"
