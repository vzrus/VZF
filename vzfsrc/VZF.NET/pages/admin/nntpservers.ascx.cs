...
namespace YAF.Pages.Admin
{
  ...
  public partial class nntpservers : AdminPage
  {
    ...
    {
      this.RankList.DataSource = LegacyDb.nntpserver_list(PageContext.PageModuleID, this.PageContext.PageBoardID, null);
      this.DataBind();
    }
    ...
    private void RankList_ItemCommand([NotNull] object source, [NotNull] RepeaterCommandEventArgs e)
    {
      switch (e.CommandName)
      {
        case "edit":
          ...
          break;
        case "delete":
          LegacyDb.nntpserver_delete(PageContext.PageModuleID, e.CommandArgument);
          this.BindData();
          break;
      }
    }
