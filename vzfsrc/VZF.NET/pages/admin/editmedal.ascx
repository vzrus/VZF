	...
	<table class="content" cellspacing="1" cellpadding="0" width="100%">
		<tr>
			<td class="header1" colspan="4">
				<VZF:LocalizedLabel ID="LocalizedLabel1" runat="server" LocalizedTag="TITLE" LocalizedPage="ADMIN_EDITMEDAL" />
             </td>
		</tr>
        <tr>
		...
		<tr>
			<td class="postheader" colspan="2">
				<VZF:HelpLabel ID="HelpLabel1" runat="server" LocalizedTag="MEDAL_NAME" LocalizedPage="ADMIN_EDITMEDAL" />
            </td>
		...
		<tr>
			<td class="postheader" colspan="2">
				<VZF:HelpLabel ID="HelpLabel2" runat="server" LocalizedTag="MEDAL_DESC" LocalizedPage="ADMIN_EDITMEDAL" />
		    </td>
			<td class="post" colspan="2">
		...
		<tr>
			<td class="postheader" colspan="2">
				<VZF:HelpLabel ID="HelpLabel3" runat="server" LocalizedTag="MEDAL_MESSAGE" LocalizedPage="ADMIN_EDITMEDAL" />
            </td>
			<td class="post" colspan="2">
		...
		<tr>
			<td class="postheader" colspan="2">
				<VZF:HelpLabel ID="HelpLabel4" runat="server" LocalizedTag="MEDAL_CATEGORY" LocalizedPage="ADMIN_EDITMEDAL" />
				</td>
			<td class="post" colspan="2">
		...
		<tr>
			<td class="postheader" colspan="2">
				<VZF:HelpLabel ID="HelpLabel5" runat="server" LocalizedTag="MEDAL_IMAGE" LocalizedPage="ADMIN_EDITMEDAL" />
            </td>
			<td class="post" colspan="2">
		...
		<tr>
			<td class="postheader" colspan="2">
				<VZF:HelpLabel ID="HelpLabel6" runat="server" LocalizedTag="RIBBON_IMAGE" LocalizedPage="ADMIN_EDITMEDAL" />
            </td>
			<td class="post" colspan="2">
		...
		<tr>
			<td class="postheader" colspan="2">
				<VZF:HelpLabel ID="HelpLabel7" runat="server" LocalizedTag="SMALL_IMAGE" LocalizedPage="ADMIN_EDITMEDAL" />
            </td>
			<td class="post" colspan="2">
		...
		<tr>
			<td class="postheader" colspan="2">
				<VZF:HelpLabel ID="HelpLabel8" runat="server" LocalizedTag="SMALL_RIBBON" LocalizedPage="ADMIN_EDITMEDAL" />
            </td>
			<td class="post" colspan="2">
		...
		<tr>
			<td class="postheader" colspan="2">
				<VZF:HelpLabel ID="HelpLabel9" runat="server" LocalizedTag="SORT_ORDER" LocalizedPage="ADMIN_EDITMEDAL" />
            </td>
			<td class="post" colspan="2">
		...
		<tr>
			<td class="postheader" colspan="2">
				<VZF:HelpLabel ID="HelpLabel10" runat="server" LocalizedTag="SHOW_MESSAGE" LocalizedPage="ADMIN_EDITMEDAL" />
            </td>
			<td class="post" colspan="2">
		...
		<tr>
			<td class="postheader" colspan="2">
				<VZF:HelpLabel ID="HelpLabel11" runat="server" LocalizedTag="ALLOW_RIBBON" LocalizedPage="ADMIN_EDITMEDAL" />
            </td>
			<td class="post" colspan="2">
		...
		<tr>
			<td class="postheader" colspan="2">
				<VZF:HelpLabel ID="HelpLabel12" runat="server" LocalizedTag="ALLOW_HIDING" LocalizedPage="ADMIN_EDITMEDAL" />
            </td>
			<td class="post" colspan="2">
		...
		<tr>
			<td class="postheader" colspan="2">
				<VZF:HelpLabel ID="HelpLabel13" runat="server" LocalizedTag="ALLOW_REORDER" LocalizedPage="ADMIN_EDITMEDAL" />
            </td>
			<td class="post" colspan="2">
		...
		<asp:Repeater ID="GroupList" runat="server" OnItemCommand="GroupList_ItemCommand">
			<HeaderTemplate>
				<tr>
					<td class="header1" colspan="4">
						<VZF:LocalizedLabel ID="LocalizedLabel1" runat="server" LocalizedTag="HEADER2" LocalizedPage="ADMIN_EDITMEDAL" />
                    </td>
				</tr>
				<tr>
					<td class="header2">
						<VZF:LocalizedLabel ID="LocalizedLabel4" runat="server" LocalizedTag="GROUP" /></td>
					<td class="header2" colspan="2">
						<VZF:LocalizedLabel ID="LocalizedLabel5" runat="server" LocalizedTag="MESSAGE" LocalizedPage="COMMON" /></td>
					<td class="header2">
						<VZF:LocalizedLabel ID="LocalizedLabel6" runat="server" LocalizedTag="COMMAND" /></td>
				</tr>
			</HeaderTemplate>
			<ItemTemplate>
				<tr>
					...
					<td class="post">
						<asp:LinkButton runat="server" CommandName="edit" CommandArgument='<%# Eval("GroupID") %>'><VZF:LocalizedLabel ID="LocalizedLabel2" runat="server" LocalizedTag="EDIT" /></asp:LinkButton>
						|
						<asp:LinkButton runat="server" CommandName="remove" CommandArgument='<%# Eval("GroupID") %>'
							OnLoad="GroupRemove_Load"><VZF:LocalizedLabel ID="LocalizedLabel3" runat="server" LocalizedTag="REMOVE" /></asp:LinkButton>
					</td>
				</tr>
			</ItemTemplate>
		</asp:Repeater>
		...
		<asp:Panel runat="server" ID="AddGroupPanel" Visible="false">
			...
			<tr>
				<td class="postheader" colspan="2">
					<VZF:HelpLabel ID="HelpLabel14" runat="server" LocalizedTag="MEDAL_GROUP" LocalizedPage="ADMIN_EDITMEDAL" />
                </td>
				<td class="post" colspan="2">
			...
			<tr>
				<td class="postheader" colspan="2">
					<VZF:HelpLabel ID="HelpLabel15" runat="server" LocalizedTag="OVERRIDE_MESSAGE" LocalizedPage="ADMIN_EDITMEDAL" />
                </td>
				<td class="post" colspan="2">
			...
			<tr>
				<td class="postheader" colspan="2">
					<VZF:HelpLabel ID="HelpLabel16" runat="server" LocalizedTag="OVERRIDE_ORDER" LocalizedPage="ADMIN_EDITMEDAL" />
                </td>
				<td class="post" colspan="2">
			...
			<tr>
				<td class="postheader" colspan="2">
					<VZF:HelpLabel ID="HelpLabel17" runat="server" LocalizedTag="ONLY_RIBBON" LocalizedPage="ADMIN_EDITMEDAL" />
                </td>
				<td class="post" colspan="2">
			...
			<tr>
				<td class="postheader" colspan="2">
                    <VZF:HelpLabel ID="HelpLabel18" runat="server" LocalizedTag="HIDE" LocalizedPage="ADMIN_EDITMEDAL" />
				</td>
				<td class="post" colspan="2">
		...
		<asp:Repeater ID="UserList" runat="server" OnItemCommand="UserList_ItemCommand">
			<HeaderTemplate>
				<tr>
					<td class="header1" colspan="4">
						<VZF:LocalizedLabel ID="LocalizedLabel1" runat="server" LocalizedTag="HEADER3" LocalizedPage="ADMIN_EDITMEDAL" />
                    </td>
				</tr>
				<tr>
					<td class="header2">
					    <VZF:LocalizedLabel ID="LocalizedLabel10" runat="server" LocalizedTag="USERNAME" LocalizedPage="ACTIVEUSERS" />
						(<VZF:LocalizedLabel ID="LocalizedLabel6" runat="server" LocalizedTag="USER" LocalizedPage="MODERATE" />)
                    </td>
					<td class="header2">
						<VZF:LocalizedLabel ID="LocalizedLabel7" runat="server" LocalizedTag="MESSAGE" LocalizedPage="COMMON" /></td>
					<td class="header2">
						<VZF:LocalizedLabel ID="LocalizedLabel8" runat="server" LocalizedTag="DATE_AWARDED" LocalizedPage="ADMIN_EDITMEDAL" /></td>
					<td class="header2">
						<VZF:LocalizedLabel ID="LocalizedLabel9" runat="server" LocalizedTag="COMMAND" /></td>
				</tr>
			</HeaderTemplate>
			<ItemTemplate>
				<tr>
					...
					<td class="post">
						<asp:LinkButton runat="server" CommandName="edit" CommandArgument='<%# Eval("UserID") %>'><VZF:LocalizedLabel ID="LocalizedLabel2" runat="server" LocalizedTag="EDIT" /></asp:LinkButton>
						|
						<asp:LinkButton runat="server" CommandName="remove" CommandArgument='<%# Eval("UserID") %>'
							OnLoad="UserRemove_Load"><VZF:LocalizedLabel ID="LocalizedLabel3" runat="server" LocalizedTag="REMOVE" /></asp:LinkButton>
					</td>
				</tr>
			</ItemTemplate>
		</asp:Repeater>
		...
		<asp:Panel runat="server" ID="AddUserPanel" Visible="false">
			...
			<tr>
				<td class="postheader" colspan="2">
					<VZF:HelpLabel ID="HelpLabel23" runat="server" LocalizedTag="MEDAL_USER" LocalizedPage="ADMIN_EDITMEDAL" />
                </td>
				<td class="post" colspan="2">
			...
			<tr>
				<td class="postheader" colspan="2">
					<VZF:HelpLabel ID="HelpLabel19" runat="server" LocalizedTag="OVERRIDE_MESSAGE" LocalizedPage="ADMIN_EDITMEDAL" />
				</td>
				<td class="post" colspan="2">
			...
			<tr>
				<td class="postheader" colspan="2">
					<VZF:HelpLabel ID="HelpLabel20" runat="server" LocalizedTag="OVERRIDE_ORDER" LocalizedPage="ADMIN_EDITMEDAL" />
				</td>
				<td class="post" colspan="2">
			...
			<tr>
				<td class="postheader" colspan="2">
					<VZF:HelpLabel ID="HelpLabel21" runat="server" LocalizedTag="ONLY_RIBBON" LocalizedPage="ADMIN_EDITMEDAL" />
				</td>
				<td class="post" colspan="2">
			...
			<tr>
				<td class="postheader" colspan="2">
					<VZF:HelpLabel ID="HelpLabel22" runat="server" LocalizedTag="HIDE" LocalizedPage="ADMIN_EDITMEDAL" />
				</td>
				<td class="post" colspan="2">
