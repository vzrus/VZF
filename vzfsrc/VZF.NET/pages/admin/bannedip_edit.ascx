	...
	<table class="content" width="100%" cellspacing="1" cellpadding="0">
		<tr>
			<td class="header1" colspan="2">
				<VZF:LocalizedLabel ID="LocalizedLabel1" runat="server" LocalizedTag="TITLE" LocalizedPage="ADMIN_BANNEDIP_EDIT" />
             </td>
		</tr>
        <tr>
		...
		<tr>
			...
			<tr>
			<td class="postheader" width="50%">
				<VZF:HelpLabel ID="HelpLabel2" runat="server" LocalizedTag="REASON" LocalizedPage="ADMIN_EDITACCESSMASKS" />
            </td>
			<td class="post" width="50%">
