	...
	<table class="content"  cellspacing="1" cellpadding="0" width="100%">
	     <tr class="header1">
	          <td class="header1" colspan="4">
                        <VZF:LocalizedLabel ID="LocalizedLabel2" runat="server" LocalizedTag="TITLE"  LocalizedPage="ADMIN_EVENTLOGROUPACCESS" />
              </td>
         </tr>
         <tr>
             <td class="header2">
                     <VZF:LocalizedLabel ID="LocalizedLabel1" runat="server" LocalizedTag="HEADER" LocalizedPage="ADMIN_EVENTLOGROUPACCESS" />&nbsp;
                     <VZF:LocalizedLabel ID="GroupNameLabel" runat="server" LocalizedTag="GROUPNAME" LocalizedPage="ADMIN_EVENTLOGROUPACCESS" />&nbsp;
                     <asp:Label ID="GroupName" runat="server"  />&nbsp;
             </td>
             <td class="header2">
                     <VZF:LocalizedLabel ID="LocalizedLabel4" runat="server" LocalizedTag="EVENT" LocalizedPage="ADMIN_EVENTLOGROUPACCESS" />&nbsp;
             </td>
             <td class="header2">
                     <VZF:LocalizedLabel ID="LocalizedLabel5" runat="server" LocalizedTag="VIEWACCESS"  LocalizedPage="ADMIN_EVENTLOGROUPACCESS" />
            </td>
             <td class="header2">
                     <VZF:LocalizedLabel ID="LocalizedLabel3" runat="server" LocalizedTag="DELETEACCESS"  LocalizedPage="ADMIN_EVENTLOGROUPACCESS" />
            </td>
        </tr>
