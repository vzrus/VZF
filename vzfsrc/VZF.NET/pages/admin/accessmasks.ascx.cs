  ...
  public partial class accessmasks : AdminPage
  {
    ...
    protected void List_ItemCommand([NotNull] object source, [NotNull] RepeaterCommandEventArgs e)
    {
      switch (e.CommandName)
      {
        ...
        case "delete":
          ...
          if (LegacyDb.accessmask_delete(this.PageContext.PageModuleID, e.CommandArgument))
          {
    ...
    private void BindData()
    {
      // list all access masks for this boeard
        this.List.DataSource = LegacyDb.accessmask_list(PageContext.PageModuleID, this.PageContext.PageBoardID, null);
      this.DataBind();
    }
