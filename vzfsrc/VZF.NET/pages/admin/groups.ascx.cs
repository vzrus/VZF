...
namespace YAF.Pages.Admin
{
  ...
  public partial class groups : AdminPage
  {
    ...
    protected void RoleListNet_ItemCommand([NotNull] object source, [NotNull] RepeaterCommandEventArgs e)
    {
      ...
      switch (e.CommandName)
      {
        case "add":
          ...
          long groupID = LegacyDb.group_save(PageContext.PageModuleID, DBNull.Value, 
    ...
    protected void RoleListYaf_ItemCommand([NotNull] object source, [NotNull] RepeaterCommandEventArgs e)
    {
      ...
      switch (e.CommandName)
      {
        ...
        case "delete":
          ...
          // delete role
          LegacyDb.group_delete(PageContext.PageModuleID, e.CommandArgument);
    ...
    private void BindData()
    {
      ...
      DataTable dt = LegacyDb.group_list(PageContext.PageModuleID, this.PageContext.PageBoardID, null);
