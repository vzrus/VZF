  ...
  <asp:Panel id="HostSettingsTabs" runat="server">
    ...
    <div id="View6">
        <table class="content" width="100%" cellspacing="2" cellpadding="2" align="center">
                    ...
                    <tr>
                        <td class="postheader">
                            <VZF:HelpLabel ID="HelpLabel225" runat="server" LocalizedTag="ALLOW_PERSONALFORUMS" LocalizedPage="ADMIN_HOSTSETTINGS" />
                        </td>
                        <td class="post">
                    ...
                    <tr>
                        <td class="postheader">
                            <VZF:HelpLabel ID="HelpLabel226" runat="server" LocalizedTag="PERSONALFORUMS_ACCESSMASKSNUMBER" LocalizedPage="ADMIN_HOSTSETTINGS" />
                        </td>
                        <td class="post">
                    ...
                    <tr>
                        <td class="postheader">
                            <VZF:HelpLabel ID="HelpLabel227" runat="server" LocalizedTag="PERSONALFORUMS_GROUPS" LocalizedPage="ADMIN_HOSTSETTINGS" />
                        </td>
                        <td class="post">
