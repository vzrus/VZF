  ...
  <asp:Panel id="HostSettingsTabs" runat="server">
    ...
    <div id="View2">
        <table class="content" width="100%" cellspacing="2" cellpadding="2" align="center">
                    ...
                    <tr>
                        <td class="header1" colspan="2">
                            <YAF:LocalizedLabel ID="LocalizedLabel37" runat="server" LocalizedTag="HEADER_TOPICTAGS" LocalizedPage="ADMIN_HOSTSETTINGS" />
                        </td>
                    </tr>
                    <tr>
                        <td class="postheader" style="width:50%">
                            <YAF:HelpLabel ID="HelpLabel220" runat="server" LocalizedTag="ALLOW_TOPICTAGS" LocalizedPage="ADMIN_HOSTSETTINGS" />
                        </td>
                        <td class="post">
    ...
    <div id="View3">
        <table class="content" width="100%" cellspacing="2" cellpadding="2" align="center">
                    ...
                    <tr>
                        <td class="postheader">
                            <YAF:HelpLabel ID="HelpLabel223" runat="server" LocalizedTag="MOSTACTIVEUSER_DAYS" LocalizedPage="ADMIN_HOSTSETTINGS" />
                        </td>
                        <td class="post">
                    ...
                    <tr>
                        <td class="header1" colspan="2">
                            <YAF:LocalizedLabel ID="LocalizedLabel38" runat="server" LocalizedTag="HEADER_SHOUT" LocalizedPage="ADMIN_HOSTSETTINGS" />
                        </td>
                    </tr>
                    <tr>
                        <td class="postheader">
