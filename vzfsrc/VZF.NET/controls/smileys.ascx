<%@ Control Language="c#" AutoEventWireup="True" Inherits="VZF.Controls.smileys" Codebehind="smileys.ascx.cs" %>
  ...
  <table class="content smiliesContent" width="100%" cellspacing="0" cellpadding="0" style="margin-top:30px">
    <tr>
      <td class="postheader header2" style="text-align:center">
        <span class="header"><VZF:LocalizedLabel ID="LocalizedLabel1" runat="server" LocalizedTag="SMILIES_HEADER" /></span>
      </td>
    </tr>
    <tr>
