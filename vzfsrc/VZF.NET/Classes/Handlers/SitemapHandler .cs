         ...
         /*   if (context.Request.UrlReferrer == null ||
                ...
                TextWriter textWriter = new StreamWriter(context.Response.OutputStream, System.Text.Encoding.UTF8))
            {
                ...
                foreach (DataRow r in dt.Rows)
                {
                    ...
                    writer.WriteElementString(
                        "lastmod",
                        DateTime.TryParse(r["LastPosted"].ToString(), out lp) ? lp.ToString("yyy-MM-dd", System.Globalization.CultureInfo.InvariantCulture) : DateTimeHelper.SqlDbMinTime().ToString("yyy-MM-dd", System.Globalization.CultureInfo.InvariantCulture));
