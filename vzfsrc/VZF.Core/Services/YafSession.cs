 ...
 * 
 * File YafSession.cs created  on 2.6.2015 in  6:29 AM.
...
namespace YAF.Core.Services
{
    ...
    public class YafSession : IYafSession
    {
        ...
        public string NntpTreeActiveNode
        {
            get
            {
                if (this.SessionState["nntptreeactivenode"] != null)
                {
                    return (string)this.SessionState["nntptreeactivenode"];
                }
        ...
        public string[] SearchTreeSelectedNodes
        {
            ...
            set
            {
                this.SessionState["searchtreeselectednodes"] = value;
            }
        }
