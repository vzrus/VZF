 ...
 * 
 * File ScriptFunctionContext.cs created  on 2.6.2015 in  6:29 AM.
...
namespace YAF.Core
{
  ...
  /// </summary>
  public class ScriptFunctionContext : IScriptFunctionContext
  {
    ...
    /// </summary>
    public IScriptFunction ScriptFunction { get; set; }

    /// <summary>
    /// Gets ScriptStatement.
    /// </summary>
    public IScriptStatement ScriptStatement
    {
      get
      {
