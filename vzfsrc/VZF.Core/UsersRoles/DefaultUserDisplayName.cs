 ...
 * 
 * File DefaultUserDisplayName.cs created  on 17.12.2015 in  5:14 PM.
...
namespace YAF.Core
{
    ...
    public class DefaultUserDisplayName : IUserDisplayName, IHaveServiceLocator
    {
        ...
        public IDictionary<int, string> Find([NotNull] string contains)
        {
            ...
            {
                found = CommonDb.UserFind(YafContext.Current.PageModuleID, YafContext.Current.PageBoardID, true, null, null, contains, null, null);
                return found.ToDictionary(k => k.UserID ?? 0, v => v.DisplayName);
            }

            found = CommonDb.UserFind(YafContext.Current.PageModuleID, YafContext.Current.PageBoardID, true, contains, null, null, null, null);
        ...
        public int? GetId([NotNull] string name)
        {
            ...
            else
            {
                ...
                {
                    var user =
                      CommonDb.UserFind(YafContext.Current.PageModuleID, YafContext.Current.PageBoardID, false, null, null, name, null, null).FirstOrDefault();
                ...
                {
                    var user =
                      CommonDb.UserFind(YafContext.Current.PageModuleID, YafContext.Current.PageBoardID, false, name, null, null, null, null).FirstOrDefault();
