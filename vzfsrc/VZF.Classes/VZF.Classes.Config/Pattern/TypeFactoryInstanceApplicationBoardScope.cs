 ...
 * 
 * File TypeFactoryInstanceApplicationBoardScope.cs created  on 2.6.2015 in  6:29 AM.
...
namespace YAF.Classes.Pattern
{
  ...
  public class TypeFactoryInstanceApplicationBoardScope<T> : TypeFactoryInstanceApplicationScope<T>
  {
    ...
    public TypeFactoryInstanceApplicationBoardScope(string typeName)
    {
      ...
      this.TypeInstanceKey = string.Format("{0}{1}{2}", typeName, YafControlSettings.Current.ModuleID, YafControlSettings.Current.BoardID);
    }
