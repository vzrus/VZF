 ...
 * 
 * File Config.cs created  on 2.6.2015 in  6:29 AM.
        ...
        public static string[] CrawlerUserAgentTokens
        {
            get
            {
                var bots =
                    ...
                    + "DeepIndex,DefaultCrawler,DittoSpyder,DIIbot,DotBot,DuckDuckGo-Favicons-Bot,EZResult,EARTHCOM.info,"
                    + "EuripBot,ESISmartSpider,FAST-WebCrawler,FeedlyBot,FyberSearch,Findexa Crawler,Fluffy,"
                    ...
                    + "ltx71,Mole2,MP3Bot,Knowledge.com,kuloko-bot,LNSpiderguy,Linknzbot,lookbot,"
                    ...
                    + "SurdotlyBot,Surfnomore,teoma,UK Searcher Spider,Synaps,Nazilla,MuscatFerret,ZyBorg,"
                    + "Web-Monitoring,WIRE WebRefiner,WSCbot,Yandex,Yellopet-Spider,YBSbot,YisouSpider:Yisou,Crawler,MozSpider";
