...
namespace YAF.Providers.Roles
{
  ...
  /// </summary>
  public class VzfFirebirdRoleProvider : RoleProvider
  {
    ...
    /// <summary>
    /// Grabs all the roles from the FbDB
    /// </summary>
    /// <returns>
    /// </returns>
    ...
    {
      return "VzfFirebirdRoleProvider-{0}-{1}".FormatWith(name, this.ApplicationName);
    }
