...
// File UserPasswordInfo.cs created  on 2.6.2015 in  6:31 AM.
...
namespace YAF.Providers.Membership
{
  ...
  /// </summary>
  internal class MySqlUserPasswordInfo
  {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="MySqlUserPasswordInfo"/> class. 
    /// Called to create a new MySqlUserPasswordInfo class instance.
    /// </summary>
    /// <param name="password">
    /// </param>
    ...
    /// <returns>
    /// </returns>
    public static MySqlUserPasswordInfo CreateInstanceFromDB(
      ...
      bool msCompliant)
    {
        DataTable userData = MySQLDB.Current.GetUserPasswordInfo(connectionStringName, appName, username, updateUser);

      if (userData.Rows.Count > 0)
      {
        DataRow userInfo = userData.Rows[0];

        // create a new instance of the MySqlUserPasswordInfo class
        return new MySqlUserPasswordInfo(
    ...
    public bool IsCorrectAnswer(string answerToCheck)
    {
      return
        this.PasswordAnswer.Equals(
          VzfMySqlMembershipProvider.EncodeString(
            answerToCheck, 
            this.PasswordFormat, 
            this.PasswordSalt, 
            this.UseSalt, 
