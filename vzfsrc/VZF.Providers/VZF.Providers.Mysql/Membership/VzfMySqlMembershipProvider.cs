...
// File VzfMySqlMembershipProvider.cs created  on 2.6.2015 in  6:31 AM.
...
namespace YAF.Providers.Membership
{
  ...
  /// </summary>
  public class VzfMySqlMembershipProvider : MembershipProvider
  {
    ...
    public override MembershipUser GetUser(string username, bool userIsOnline)
    {
      ...
      // if it's empty don't bother calling the MySQLDB.
    ...
    private static string DecodeString(string pass, int passwordFormat)
    {
      switch ((MembershipPasswordFormat)Enum.ToObject(typeof(MembershipPasswordFormat), passwordFormat))
      {
        ...
        case MembershipPasswordFormat.Encrypted:
          ...
          byte[] bRet = (new VzfMySqlMembershipProvider()).DecryptPassword(bIn);
          if (bRet == null)
          {
            return null;
          }
    ...
    private static string Encrypt(string clearString, string saltString, bool standardComp)
    {
      ...
      return Convert.ToBase64String((new VzfMySqlMembershipProvider()).EncryptPassword(buffer));
    }
