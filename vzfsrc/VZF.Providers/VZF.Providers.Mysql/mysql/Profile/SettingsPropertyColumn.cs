...
namespace YAF.Providers.Profile
{
  ...
  /// </summary>
  public class MySqlSettingsPropertyColumn
  {
    ...
    /// </summary>
    public MySqlSettingsPropertyColumn()
    {
    ...
    /// The size.
    /// </param>
    public MySqlSettingsPropertyColumn(SettingsProperty settings, MySqlDbType dataType, int size)
    {
