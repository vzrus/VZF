...
// File PgMembershipProvider.cs created  on 2.6.2015 in  6:31 AM.
    ...
    public class PgMembershipProvider : MembershipProvider
    {
            ...
            string newPasswordAnswer)
        {
            ...
            if (currentPasswordInfo.IsCorrectPassword(password))
            {
                try
                {
                    Db.__ChangePasswordQuestionAndAnswer(
                        ConnectionStringName,
                        this.ApplicationName,
                        username,
                        newPasswordQuestion,
            ...
            out int totalRecords)
        {
            ...
            foreach (
                DataRow dr in
                    Db.__FindUsersByEmail(ConnectionStringName, this.ApplicationName, emailToMatch, pageIndex, pageSize)
                        .Rows)
            {
        ...
        public override MembershipUserCollection GetAllUsers(int pageIndex, int pageSize, out int totalRecords)
        {
            ...
            // Loop through all users
            foreach (
                DataRow dr in Db.__GetAllUsers(ConnectionStringName, this.ApplicationName, pageIndex, pageSize).Rows)
            {
                // Add new user to collection
                users.Add(this.UserFromDataRow(dr));
            }
        ...
        {
            return Db.__GetNumberOfUsersOnline(
                ConnectionStringName,
                this.ApplicationName,
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            this._minRequiredNonAlphanumericCharacters = int.Parse(
            ...
            {
                this._connStrName = Config.ConnectionStringName;
            }
        ...
        public override void UpdateUser(MembershipUser user)
        {
            ...
            // Update User
            int updateStatus = Db.__UpdateUser(
                ConnectionStringName,
                this.ApplicationName,
                user,
        ...
        private static string GeneratePassword(int minPassLength, int minNonAlphas)
        {
            return Membership.GeneratePassword(
                minPassLength < _passwordsize ? _passwordsize : minPassLength,
                minNonAlphas);
        }
