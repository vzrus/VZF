...
namespace YAF.Providers.Membership
{
  ...
  /// </summary>
  internal class PgUserPasswordInfo
  {
    ...
    /// <returns>
    /// </returns>
    public static PgUserPasswordInfo CreateInstanceFromDB(
      ...
      bool msCompliant)
    {
        DataTable userData = Db.__GetUserPasswordInfo(connectionStringName, appName, username, updateUser);
    ...
    public bool IsCorrectAnswer(string answerToCheck)
    {
      return
        this.PasswordAnswer.Equals(
          PgMembershipProvider.EncodeString(
            answerToCheck, 
            this.PasswordFormat, 
            this.PasswordSalt, 
            this.UseSalt, 
