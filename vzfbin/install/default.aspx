            ...
            <WizardSteps>
                ...
                <asp:WizardStep runat="server" Title="Database Connection" ID="WizDatabaseConnection">
                    ...
                    <asp:PlaceHolder ID="NewConnectionHolder" runat="server" Visible="false">
                        ...
                        <br />
                        <br />
                        <asp:Repeater ID="PropertiesList" runat="server" >
                            <ItemTemplate>
                                 <asp:Label ID="ParameterName" Text='<%# Bind("Name") %>' runat="server" Width="500px" />
                                <asp:TextBox runat="server" ID="ParameterValue" Text='<%# Bind("Value") %>' Width="500px" /><br />
                            </ItemTemplate>
                        </asp:Repeater> 
                        <br />
                        <br />
