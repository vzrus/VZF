...
<VZF:AdminMenu runat="server">
    <asp:Panel id="EditUserTabs" runat="server">
               <ul>
                 <li><a href="#View1"><VZF:LocalizedLabel ID="LocalizedLabel1" runat="server" LocalizedTag="USER_DETAILS" LocalizedPage="ADMIN_EDITUSER" /></a></li>
                 <li><a href="#View2"><VZF:LocalizedLabel ID="LocalizedLabel2" runat="server" LocalizedTag="USER_ROLES" LocalizedPage="ADMIN_EDITUSER" /></a></li>
                 <li><a href="#View3"><VZF:LocalizedLabel ID="LocalizedLabel3" runat="server" LocalizedTag="USER_PROFILE" LocalizedPage="ADMIN_EDITUSER" /></a></li>
                 <li><a href="#View4"><VZF:LocalizedLabel ID="LocalizedLabel4" runat="server" LocalizedTag="USER_AVATAR" LocalizedPage="ADMIN_EDITUSER" /></a></li>
                 <li><a href="#View5"><VZF:LocalizedLabel ID="LocalizedLabel5" runat="server" LocalizedTag="USER_SIG" LocalizedPage="ADMIN_EDITUSER" /></a></li>		        
                 <li runat="server" id="View6Li" Visible="<%#!IsGuestUser%>"><a href='#<%# this.View6.ClientID %>'><VZF:LocalizedLabel ID="LocalizedLabel6" runat="server" LocalizedTag="USER_PASS" LocalizedPage="ADMIN_EDITUSER" /></a></li>	
                 <li><a href="#View7"><VZF:LocalizedLabel ID="LocalizedLabel7" runat="server" LocalizedTag="USER_REPUTATION" LocalizedPage="ADMIN_EDITUSER" /></a></li>
                 <li runat="server" id="View8Li" Visible="<%#!IsGuestUser%>"><a href='#<%# this.View8.ClientID %>'><VZF:LocalizedLabel ID="LocalizedLabel8" runat="server" LocalizedTag="USER_SUSPEND" LocalizedPage="ADMIN_EDITUSER" /></a></li>
                 <li runat="server" id="View9Li" Visible="<%#!IsGuestUser%>"><a href='#<%# this.View9.ClientID %>'><VZF:LocalizedLabel ID="LocalizedLabel9" runat="server" LocalizedTag="USER_KILL" LocalizedPage="ADMIN_EDITUSER" /></a></li>
