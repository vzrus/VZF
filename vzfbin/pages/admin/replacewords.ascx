			...
			<table class="content" cellspacing="1" cellpadding="0" width="100%">
				<tr>
					<td class="header1" colspan="3">
						<VZF:LocalizedLabel ID="LocalizedLabel1" runat="server" LocalizedTag="TITLE" LocalizedPage="ADMIN_REPLACEWORDS" />
					</td>
				</tr>
				<tr>
					<td class="header2">
                        <VZF:LocalizedLabel ID="LocalizedLabel2" runat="server" LocalizedTag="BAD" LocalizedPage="ADMIN_REPLACEWORDS" />
					</td>
					<td class="header2">
                        <VZF:LocalizedLabel ID="LocalizedLabel3" runat="server" LocalizedTag="GOOD" LocalizedPage="ADMIN_REPLACEWORDS" />
					</td>
					<td class="header2">
						&nbsp;
					</td>
  ...
  <VZF:LocalizedLabel ID="LocalizedLabel2" runat="server" LocalizedTag="EDIT" />
					...
					<asp:LinkButton runat="server"  CommandName='delete' OnLoad="Delete_Load"
						CommandArgument='<%# Eval("ID") %>' ID="Linkbutton2">
                          <VZF:LocalizedLabel ID="LocalizedLabel4" runat="server" LocalizedTag="DELETE" />
					</asp:LinkButton>
				</td>
			</tr>
		</ItemTemplate>
