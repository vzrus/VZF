	...
	<table cellpadding="0" cellspacing="1" class="content" width="100%">
		<tr>
			<td colspan="2" class="header1">
				<VZF:LocalizedLabel ID="LocalizedLabel1" runat="server" LocalizedTag="HEADER" LocalizedPage="ADMIN_REINDEX" />
			</td>
		</tr>
        <tr>
			...
			<asp:Placeholder ID="PanelGetStats" runat="server" Visible="False">
				<td valign="top">
					<asp:Button ID="btnGetStats" CssClass="pbutton" runat="server" OnClick="btnGetStats_Click" Text="Table Index Statistics"
						Width="200px" />
					<br />
					<VZF:LocalizedLabel ID="LocalizedLabel2" runat="server" LocalizedTag="SHOW_STATS" LocalizedPage="ADMIN_REINDEX" />
				</td>
			</asp:Placeholder>
		...
		<tr class="footer1">
			<asp:Placeholder ID="PanelReindex" runat="server" Visible="False">
				<td valign="top">
					...
					<br />
                    <VZF:LocalizedLabel ID="LocalizedLabel4" runat="server" LocalizedTag="REINDEX" LocalizedPage="ADMIN_REINDEX" />
				</td>
			</asp:Placeholder>
		</tr>
		<tr class="footer1">
			<asp:Placeholder ID="PanelShrink" runat="server" Visible="False">
				<td valign="top">
                    ...
                    <VZF:LocalizedLabel ID="LocalizedLabel3" runat="server" LocalizedTag="SHRINK" LocalizedPage="ADMIN_REINDEX" />
				</td>
			</asp:Placeholder>
		</tr>
	</table>
