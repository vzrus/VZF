	...
	<table class="content" width="100%" cellspacing="1" cellpadding="0">
		<tr>
			<td class="header1" colspan="2">
				<VZF:LocalizedLabel ID="LocalizedLabel1" runat="server" LocalizedTag="HEADER" LocalizedPage="ADMIN_RUNSQL" />
			</td>
		</tr>
        <tr>
		...
		<tr>
			<td class="postheader" style="width: 100px" valign="top">
				<strong><VZF:LocalizedLabel ID="LocalizedLabel2" runat="server" LocalizedTag="SQL_COMMAND" LocalizedPage="ADMIN_RUNSQL" /></strong>
			</td>
			<td class="post">
