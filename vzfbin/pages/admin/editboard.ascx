    ...
    <table class="content" cellspacing="1" cellpadding="0" width="100%">
        <tr>
            <td class="header1" colspan="2">
               <VZF:LocalizedLabel ID="LocalizedLabel1" runat="server" LocalizedTag="TITLE" LocalizedPage="ADMIN_EDITBOARD" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td width="50%" class="postheader">
                <VZF:HelpLabel ID="HelpLabel1" runat="server" LocalizedTag="NAME" LocalizedPage="ADMIN_EDITBOARD" />
            </td>
            <td width="50%" class="post">
              ...
              <tr>
            <td width="50%" class="postheader">
                <VZF:HelpLabel ID="HelpLabel2" runat="server" LocalizedTag="CULTURE" LocalizedPage="ADMIN_EDITBOARD" />
            </td>
            <td width="50%" class="post">
        ...
        <tr>
            <td class="postheader">
                <VZF:HelpLabel ID="HelpLabel3" runat="server" LocalizedTag="THREADED" LocalizedPage="ADMIN_EDITBOARD" />
            </td>
            <td class="post">
        ...
        <tr>
            <td width="50%" class="postheader">
                <VZF:HelpLabel ID="HelpLabel4" runat="server" LocalizedTag="MEMBSHIP_APP_NAME" LocalizedPage="ADMIN_EDITBOARD" />
            </td>
            <td width="50%" class="post">
        ...
        <tr>
            <td class="postheader">
                <VZF:HelpLabel ID="HelpLabel5" runat="server" LocalizedTag="ADMIN_USER" LocalizedPage="ADMIN_EDITBOARD" />
            </td>
            <td class="post">
        ...
        <asp:PlaceHolder runat="server" ID="AdminInfo" Visible="false">
            <tr>
                <td colspan="2" class="header2">
                  <VZF:LocalizedLabel ID="LocalizedLabel2" runat="server" LocalizedTag="HEADER2" LocalizedPage="ADMIN_EDITBOARD" />
                </td>
            </tr>
            <tr>
                <td class="postheader">
                    <VZF:HelpLabel ID="HelpLabel6" runat="server" LocalizedTag="USER_NAME" LocalizedPage="ADMIN_EDITBOARD" />
                </td>
                <td class="post">
            ...
            <tr>
                <td class="postheader">
                    <VZF:HelpLabel ID="HelpLabel7" runat="server" LocalizedTag="USER_MAIL" LocalizedPage="ADMIN_EDITBOARD" />
                </td>
                <td class="post">
            ...
            <tr>
                <td class="postheader">
                    <VZF:HelpLabel ID="HelpLabel8" runat="server" LocalizedTag="USER_PASS" LocalizedPage="ADMIN_EDITBOARD" />
                </td>
                <td class="post">
            ...
            <tr>
                <td class="postheader">
                    <VZF:HelpLabel ID="HelpLabel9" runat="server" LocalizedTag="VERIFY_PASS" LocalizedPage="ADMIN_EDITBOARD" />
                </td>
                <td class="post">
            ...
            <tr>
                <td class="postheader">
                    <VZF:HelpLabel ID="HelpLabel10" runat="server" LocalizedTag="SECURITY_QUESTION" LocalizedPage="ADMIN_EDITBOARD" />
                </td>
                <td class="post">
            ...
            <tr>
                <td class="postheader">
                    <VZF:HelpLabel ID="HelpLabel11" runat="server" LocalizedTag="SECURITY_ANSWER" LocalizedPage="ADMIN_EDITBOARD" />
                </td>
                <td class="post">
