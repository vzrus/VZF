...
<table class="content" width="100%" cellspacing="1" cellpadding="0">
	...
	<tr>
		<td class="postheader" width="50%">
			<VZF:LocalizedLabel ID="LocalizedLabel2" runat="server" LocalizedTag="select_forum" />
		</td>
		...
		<tr id="trLeaveLink" runat="server">
			<td class="postheader" width="50%">
				<VZF:LocalizedLabel ID="LocalizedLabel3" runat="server" LocalizedTag="LEAVE_POINTER" />
			</td>
			<td class="post" width="50%">
	...
	<tr>
		...
		<tr id="trLeaveLinkDays" runat="server">
			<td class="postheader" width="50%">
				<VZF:LocalizedLabel ID="LocalizedLabel4" runat="server" LocalizedTag="POINTER_DAYS" />
			</td>
			<td class="post" width="50%">
