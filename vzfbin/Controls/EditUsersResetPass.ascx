<%@ Control Language="C#" AutoEventWireup="true" Inherits="VZF.Controls.EditUsersResetPass"CodeBehind="EditUsersResetPass.ascx.cs" %>
        ...
        <table width="100%" class="content" cellspacing="1" cellpadding="4">
            <tr>
                <td class="header1" colspan="2">
                    <VZF:LocalizedLabel ID="LocalizedLabel1" runat="server" LocalizedTag="HEAD_USER_RESETPASS" LocalizedPage="ADMIN_EDITUSER" />
                </td>
            </tr>
            <asp:PlaceHolder ID="PasswordResetErrorHolder" runat="server" Visible="false">
                <tr>
                    <td class="header2" colspan="2">
                        <VZF:LocalizedLabel ID="LocalizedLabel2" runat="server" LocalizedTag="ERROR_NOTE_PASSRESET" LocalizedPage="ADMIN_EDITUSER" />
                    </td>
                </tr>
            </asp:PlaceHolder>
            <tr>
                <td class="postheader">
                    <strong><VZF:LocalizedLabel ID="LocalizedLabel3" runat="server" LocalizedTag="PASS_OPTION" LocalizedPage="ADMIN_EDITUSER" /></strong>
                </td>
                <td class="post">
            ...
            <asp:PlaceHolder ID="ChangePasswordHolder" runat="server" Visible="false">
                <tr>
                <td class="header2" colspan="2">
                    <VZF:LocalizedLabel ID="LocalizedLabel4" runat="server" LocalizedTag="HEAD_USER_CHANGEPASS" LocalizedPage="ADMIN_EDITUSER" />
                </td>
                </tr>
                <tr>
                    <td class="postheader">
                        <VZF:HelpLabel ID="HelpLabel1" runat="server" LocalizedTag="CHANGE_NEW_PASS" LocalizedPage="ADMIN_EDITUSER" />
                    </td>
                    <td class="post" width="50%">
                        <strong><VZF:LocalizedLabel ID="LocalizedLabel5" runat="server" LocalizedTag="PASSWORD_REQUIREMENTS" LocalizedPage="ADMIN_EDITUSER" /></strong>
                        <br />
                ...
                <tr>
                    <td class="postheader">
                        <VZF:HelpLabel ID="HelpLabel2" runat="server" LocalizedTag="CONFIRM_PASS" LocalizedPage="ADMIN_EDITUSER" />
                    </td>
                    <td class="post" width="50%">
                ...
                <tr>
                    <td class="postheader">
                        <VZF:HelpLabel ID="HelpLabel3" runat="server" LocalizedTag="CHANGE_PASS_NOTIFICATION" LocalizedPage="ADMIN_EDITUSER" />
                    </td>
                    <td class="post" width="50%">
